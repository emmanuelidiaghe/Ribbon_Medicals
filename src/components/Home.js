                    ...
                    <div className="mt2 mb2 ml2">
                        <select name="currency"
                            ...
                            >
                                ...
                                <option value="APGT">APGT</option>
                                <option value="RMPN">RMPN</option>
                                <option value="OOPU">OOPU</option>
                                <option value="WEMA">WEMA</option>
                                <option value="PPPA">PPPA</option>
                        </select>
                        <input className="w-60 ml2" placeholder="0.000000001" />
                ...
                <div className="">
                    ...
                    <div>
                        <div className="center pa2 flex justify-between outline">
                            <img src={hiv_logo} className="mt0 w2 h2" alt="hiv test" />
                            <h4 className="mt1 mb0">HIV Blood Draw Test</h4>
                            <h4 className="mt1 mb0">A100</h4>
                        </div>
                        <div className="center pa2 flex justify-between outline">
                            <img src={lungs_logo} className="mt0 w2 h2" alt="radiology" />
                            <h4 className="mt1 mb0">TB Radiology XRay</h4>
                            <h4 className="mt1 mb0">A30</h4>
                        </div>
                        <div className="center pa2 flex justify-between outline">
                            <img src={pressure_logo} className="mt0 w2 h2" alt="blood pressure"/>
